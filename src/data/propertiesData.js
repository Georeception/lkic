...
export const propertiesData = [
  {
    ...
    images: [
      '/images/nina.jpeg',
      '/images/nina.jpeg', // Add more image paths here
      '/images/nina.jpeg',
    ],
    price: 'Contact for Pricing',
    features: [
      { label: 'Bedrooms', value: '2-3 BR', icon: <HomeIcon /> },
      { label: 'Bathrooms', value: '2-3 BA', icon: <LocationOnIcon /> },
      { label: 'Size', value: '1,200-1,800 sqft', icon: <StarIcon /> },
    ],
    amenities: [
      '24/7 Security',
      'Parking Spaces',
  ...
  },
  {
    ...
    images: [
      '/images/geomap.jpeg',
      '/images/geomap.jpeg', // Add more image paths here
      '/images/geomap.jpeg',
    ],
    price: 'Contact for Pricing',
    features: [
      { label: 'Floors', value: '5 Floors', icon: <HomeIcon /> },
      { label: 'Units', value: '20+ Offices', icon: <LocationOnIcon /> },
      { label: 'Parking', value: '50+ Spaces', icon: <StarIcon /> },
    ],
    amenities: [
      'High-Speed Internet',
      'Meeting Rooms',
  ...
  },
  {
    ...
    images: [
      '/images/exp.jpeg',
      '/images/exp.jpeg', // Add more image paths here
      '/images/exp.jpeg',
    ],
    price: 'Contact for Rates',
    features: [
      { label: 'Rooms', value: '30+ Villas', icon: <HomeIcon /> },
      { label: 'Restaurants', value: '3 Restaurants', icon: <LocationOnIcon /> },
      { label: 'Beach Access', value: 'Direct', icon: <StarIcon /> },
    ],
    amenities: [
      'Spa & Wellness',
      'Fine Dining',
  ...
  },
  {
    ...
    images: [
      //'/images/vpingo.jpeg',
      '/images/vi.jpeg', // Add more image paths here
      '/images/vip.jpeg',
    ],
    price: 'Contact for Pricing',
    features: [
      { label: 'Bedrooms', value: '5-6 BR', icon: <HomeIcon /> },
      { label: 'Bathrooms', value: '5-6 BA', icon: <LocationOnIcon /> },
      { label: 'Size', value: '5,000+ sqft', icon: <StarIcon /> },
    ],
    amenities: [
      'Golf Course Access',
      'Ocean Views',
